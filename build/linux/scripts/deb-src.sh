...
function usage()
{
    ...
    echo "Example: deb-src.sh -d xenial -k BEEFFACE -D $HOME/armadito/build/pkg armadito-pdf-0.12.4.tar.gz"
    echo ""
    echo "Argument:"
...
function build_deb_src()
{
    ...
    local DEBIAN_DIR=$SCRIPT_DIR/../packages/$PKG/debian

    mkdir_if_needed $BUILD_DIR

    # rm previous files and dir
